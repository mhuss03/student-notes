...
export default function NavBar({
  ...
  return (
    <>
      <div className="sticky top-0 flex h-[8vh] w-full items-center justify-between border-b-2 border-secondary bg-primary">
        <svg
        ...
        <div className="flex w-1/4 justify-end gap-2 pr-2 md:gap-6">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
