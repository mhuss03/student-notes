...
export default function NavBar({
  ...
  return (
    <>
      <div className="sticky top-0 flex h-[8vh] w-full items-center justify-between bg-primary px-2 md:h-[10vh]">
        <svg
        ...
        <div className="">
          <select
            name="number"
            id=""
            className="flex items-center space-x-2 rounded-full bg-white/10 px-4 py-2 text-white"
            value={surahNumber}
